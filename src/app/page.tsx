...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      buttons={[{ text: "Ma'lumotni ko'rish", href: "#ma'lumot" }]}
      avatars={[
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      useInvertedBackground={true}
      testimonials={[
        { id: "t1", name: "Aziz", handle: "@aziz_chem", testimonial: "O'yinlar orqali o'rganish juda qiziqarli!", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/teen-girl-with-tablet-sitting-library_23-2147860568.jpg" },
        { id: "t2", name: "Madina", handle: "@madi_science", testimonial: "Temir haqida ko'p narsani bilib oldim.", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/woman-with-test-tube-looking-kids-class_259150-60265.jpg" },
        { id: "t3", name: "Bobur", handle: "@bobur_dev", testimonial: "Dastur dizayni ajoyib, o'rganish oson.", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/front-view-young-male-chemist-white-suit-front-table-with-colored-solutions-writing-down-notes-light-table-science-work-lab-chemistry_140725-37983.jpg" },
        { id: "t4", name: "Sevara", handle: "@sev_learn", testimonial: "Interaktiv savollar bilimimni tekshirishga yordam berdi.", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/student-online-cute-young-guy-studying-computer-glasses-green-shirt-smiling-reading-notes_140725-164694.jpg" },
        { id: "t5", name: "Xusan", handle: "@xusan_study", testimonial: "Eng yaxshi kimyo sayti!", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/happy-kids-elementary-school_53876-138146.jpg" },
      ]}
      showRating={true}
  ...
  <div id="footer" data-section="footer">
      <FooterLogoReveal
      logoText="Temir (Fe)"
      leftLink={{ text: "Bosh sahifa", href: "/" }}
      rightLink={{ text: "Aloqa", href: "#contact" }}
    />
  </div>
      </ReactLenis>
    </ThemeProvider>
